...
/* package finflow-api-0.1.0.0 */
#ifndef VERSION_finflow_api
#define VERSION_finflow_api "0.1.0.0"
#endif /* VERSION_finflow_api */
#ifndef MIN_VERSION_finflow_api
#define MIN_VERSION_finflow_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_finflow_api */
